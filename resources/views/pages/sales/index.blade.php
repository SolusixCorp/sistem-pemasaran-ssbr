                ...
                <div class="card-header">
                    <span class="pull-right">
                        <a class="btn btn-primary" href="{{ url('/sales/create') }}">
                            <i class="fas fa-plus" aria-hidden="true"></i> Transaksi Baru
                        </a>
                    </span>
                    <h3><i class="fas fa-gifts"></i> Penjualan</h3>
                </div>
                <div class="card-body">
        ...
        function detailsView(id) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var base_url = "{{ url('/') }}";
                    $('#data-detail-modal').append('<a href="'+ base_url +'/sales/print-invoice/' + data.id + '" class="btn btn-primary pull-right">Cetak Invoice</a>');
