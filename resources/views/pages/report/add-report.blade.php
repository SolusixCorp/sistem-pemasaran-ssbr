        ...
        <div class="col-12" id="add-order">
            <div class="card mb-3">
                <div class="card-header">
                    <h3><i class="fas fa-chart-line"></i> Report Baru</h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" autocomplete="off" action="{{ route('report.store') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="modal-footer">
                                <a href="/Report" class="btn btn-secondary">Batal</a>
