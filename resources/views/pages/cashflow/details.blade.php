            ...
            <div class="modal-body">
                <div class="widget-messages" id="data-detail-modal" style="margin-top: 0px;">
                    ...
                    <div class="message-item">
                        ...
                        <h6 id="vTanngalInput" class="message-item-date"></h6>
                    </div>

                    <div class="message-item">
                        <h6 class="message-item-user">Nama Depo</h6>
                        <h6 id="vDepoName" class="message-item-date"></h6>
                    </div>

                    <div class="message-item">
                        <h6 class="message-item-user">Tipe Kas</h6>
                        <h6 id="vCashType" class="message-item-date"></h6>
                    </div>
                    ...
                    <div class="message-item">
                        ...
                        <h6 id="vNotes" class="message-item-date"></h6>
                    </div>
