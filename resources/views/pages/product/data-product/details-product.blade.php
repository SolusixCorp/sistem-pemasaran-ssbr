<!-- Modal -->
<div class="modal fade" id="modal-details-product" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <img class="img-fluid" data-toggle="magnify" src="https://via.placeholder.com/600x350" alt="Sample Image">
                    </div>
                </div>
                <div class="widget-messages" style="margin-top: 20px;">
                    
                        <div class="message-item">
                            <h6 class="message-item-user">Nama Product</h6>
                            <h6 id="vName" class="message-item-date"></h6>
                        </div>

                        <div class="message-item">
                            <h6 class="message-item-user">Kategori Product</h6>
                        ...
                        <!-- <div class="message-item">
                            ...
                            <h6 id="vDiscount" class="message-item-date"></h6>
                        </div> -->
