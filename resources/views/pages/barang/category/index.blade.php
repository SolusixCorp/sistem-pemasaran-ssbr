        ...
        <div class="col-12" id="list-category">
            <div class="card mb-3">
                <div class="card-header">
                    <span class="pull-right"><button class="btn btn-primary" onclick="addForm()"><i class="fas fa-plus" aria-hidden="true"></i> Kategori Baru</button></span>                   
                    @include('pages/barang/category/add-category')
                    @include('pages/barang/category/edit-category')
...
@section('custom_js')
    ...
    function editForm($id) {
        url = "category-barang/" + $id;
        $('.modal-title').text('Edit Kategori');
        $.ajax({
            url: "category-barang/" + $id + "/edit",
            type: "GET",
            dataType: "JSON",
